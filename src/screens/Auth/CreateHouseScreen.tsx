...
export default function CreateHouseScreen({ navigation }: Props) {
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      formData.description.length > VALIDATION.NOTES_MAX_LENGTH
    ) {
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>
              Set up your shared living space and start managing expenses
              together
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoText}>
                💡 As the house creator, you'll be the admin and can invite
                others using a unique invite code.
              </Text>
            </View>
          </View>
        </ScrollView>
