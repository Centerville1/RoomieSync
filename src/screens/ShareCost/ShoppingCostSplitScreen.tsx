...
export default function ShoppingCostSplitScreen({ navigation }: Props) {
  ...
  const { selectedShoppingItems, setSelectedShoppingItems, clearSelection } =
          ...
          {purchasedItems.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptySubtitle}>
                Add items to your shopping list first, then come back to split
                the cost.
              </Text>
              <Button
            ...
            <>
              ...
              <View style={styles.actions}>
                <Button
                  ...
                  disabled={
                    purchasedItems.filter((item) => item.isSelected).length ===
                      0 ||
                    !totalAmount ||
